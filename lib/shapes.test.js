...
describe ('circle.renderSVG', ()=>{
    ...
    it('should return the svg code for a circle', ()=>{
        ...
        expect(result).toEqual(`<svg width="300" height="200"><circle cx="150" cy="100" r="100" fill="white" /><text x="150" y="100" text-anchor="middle" font-weight="bold" font-size="2em" fill="red">ruf</text></svg>`)
    })
...
describe ('square.renderSVG', ()=>{
    ...
    it('should return the svg code for a square', ()=>{
        ...
        const result= shape.renderSVG()
        expect(result).toEqual(`<svg width="300" height="200"><rect x="0" y="0" width="150" height="150" style="fill:white" /><text x="75" y="75" text-anchor="middle" fill="red" font-weight="bold" font-size="2em">ruf</text></svg>`)
    })
